...
CREATE TABLE `invoices` (
  ...
  `payment_status` enum('UNPAID','PAID','OVERDUE') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT 'UNPAID',
...
CREATE TABLE `maintenance_requests` (
  ...
  `status` enum('PENDING','PROCESSING','DONE') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT 'PENDING',
...
INSERT INTO `services` (`id`, `service_name`, `unit_price`, `unit`, `description`, `name`, `price_per_unit`) VALUES
(1, 'Điện', 0.00, 'kWh', NULL, 'Điện', 3500.00),
(2, 'Nước', 0.00, 'm3', NULL, 'Nước', 15000.00);
...
INSERT INTO `service_usage` (`id`, `room_id`, `service_id`, `old_value`, `new_value`, `month`, `year`, `current_reading`, `previous_reading`, `reading_date`, `reading_month`, `reading_year`, `amount`) VALUES
(2, 2, 2, 0, 9, 3, 2026, 9, 0, '2026-03-23', 3, 2026, 135000.00),
(3, 2, 1, 0, 190, 3, 2026, 190, 0, '2026-03-23', 3, 2026, 665000.00),
(4, 1, 1, 0, 20, 3, 2026, 20, 0, '2026-03-23', 3, 2026, 70000.00),
(5, 1, 2, 0, 2, 3, 2026, 2, 0, '2026-03-23', 3, 2026, 30000.00);
...
CREATE TABLE `users` (
  ...
  `provider` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT 'LOCAL',
  `status` int NOT NULL,
  `created_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
...
(1, 'admin', '$2a$10$jzDVQBecWq8JCN1soWCXz.oYUhiUFBr4r8SDljrA3upCOe0RvCw9C', 'Phạm Thị Ái Ngân', NULL, 'ngan.admin@gmail.com', NULL, NULL, NULL, NULL, 1, 'LOCAL', 1, '2026-03-22 13:02:25', 1),
...
(4, '0911278938', '$2a$10$fUrsgn.mK6RQuFdauOLYE.Xrxs/0ND5VpX16QUv8oSqSY4RRasMXe', 'Trần Thị Thanh Mai', NULL, 'mait6464@gmail.com', NULL, '066304012060', NULL, NULL, 2, 'LOCAL', 1, '2026-03-23 10:11:04', 1);
